...
template <typename T, typename K = int> class Cache2Q {
private:
...
public:
  ...
  template <typename F> bool lookupUpdate(K key, F slowGetPage);
...
private:
  ...
  template <typename F> void addToIn(K key, F slowGetPage);
